...
function AddPost(): JSX.Element {
  ...
  const fetchData: (values: PostRequest) => Promise<AxiosResponse> = async (values: PostRequest) =>
        ...
        <div className="row m-3">
          ...
          <div className="form-check form-switch col-6">
            <input
              ...
              onChange={formik.handleChange}
            />
            <label className="form-check-label" htmlFor="addCommentEnabled">
              Comments Enabled
            </label>
          </div>
          <div className="form-check form-switch col-6">
            <input
              ...
              onChange={formik.handleChange}
            />
            <label className="form-check-label" htmlFor="addReactionsEnabled">
              Reactions Enabled
            </label>
          </div>
        </div>
